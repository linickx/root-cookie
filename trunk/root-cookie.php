...
function wp_set_auth_cookie($user_id, $remember = false, $secure = '') {
	...
	if (is_multisite()) {
		// individual user sites in a multi-site install cannot access root cookie options
		// this will not work with subdomain based MU installs
	...
	if ( version_compare(phpversion(), '5.2.0', 'ge') ) {
		...
		*/
		setcookie(LOGGED_IN_COOKIE, $logged_in_cookie, $expire, ROOT_COOKIE, $domain, $secure, true);
		...
		/** Duplicate of above - Created by Find & Replace
			setcookie($auth_cookie_name, $auth_cookie, $expire, ROOT_COOKIE, $cookie_domain, $secure);
		*/
		setcookie(LOGGED_IN_COOKIE, $logged_in_cookie, $expire, ROOT_COOKIE, $cookie_domain, $secure);
...
function wp_clear_auth_cookie() {
	...
	$secure = is_ssl() ? true : false;
	$httponly = version_compare(phpversion(), '5.2.0', 'ge') ? true : false;

	setcookie(AUTH_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(SECURE_AUTH_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(AUTH_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(SECURE_AUTH_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(LOGGED_IN_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(LOGGED_IN_COOKIE, ' ', time() - 31536000, SITECOOKIEPATH, $domain, $secure, $httponly);

	// Old cookies
	setcookie(AUTH_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(AUTH_COOKIE, ' ', time() - 31536000, SITECOOKIEPATH, $domain, $secure, $httponly);
	setcookie(SECURE_AUTH_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(SECURE_AUTH_COOKIE, ' ', time() - 31536000, SITECOOKIEPATH, $domain, $secure, $httponly);

	// Even older cookies
	setcookie(USER_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(PASS_COOKIE, ' ', time() - 31536000, ROOT_COOKIE, $domain, $secure, $httponly);
	setcookie(USER_COOKIE, ' ', time() - 31536000, SITECOOKIEPATH, $domain, $secure, $httponly);
	setcookie(PASS_COOKIE, ' ', time() - 31536000, SITECOOKIEPATH, $domain, $secure, $httponly);
}
endif;
